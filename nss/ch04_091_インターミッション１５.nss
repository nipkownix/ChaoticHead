...
[text001]
//【判】
<voice name="判" class="判" src="ch04/09100010bn">
...
//【諏訪】
<voice name="諏訪" class="諏訪" src="ch04/09100020su">
{#TIPS_万有引力 = true;}
...
//【判】
<voice name="判" class="判" src="ch04/09100030bn">
...
[text002]
//【諏訪】
<voice name="諏訪" class="諏訪" src="ch04/09100040su">
"Unfortunately&, I didn't study the occult at college&."

//【判】
<voice name="判" class="判" src="ch04/09100050bn">
"This isn't occult-related&."

//【判】
<voice name="判" class="判" src="ch04/09100060bn">
"There are a bunch of spots in the world where gravity becomes
unbalanced&."

//【諏訪】
<voice name="諏訪" class="諏訪" src="ch04/09100070su">
"Becomes unbalanced&.&.&.&."

//【判】
<voice name="判" class="判" src="ch04/09100080bn">
"That's what made the pendulum trace an ellipse&."

//◆ＧＥ＝ジーイー
//【判】
<voice name="判" class="判" src="ch04/09100090bn">
"They call it the 'GE rate&.'"

//【諏訪】
<voice name="諏訪" class="諏訪" src="ch04/09100100su">
"Gee Eee rate?"
...
//【判】
<voice name="判" class="判" src="ch04/09100110bn">
"Aaahhh&, what was the official name again&.&.&.&."

//【判】
<voice name="判" class="判" src="ch04/09100120bn">
...
[text003]
//【諏訪】
<voice name="諏訪" class="諏訪" src="ch04/09100130su">
"If you're talking about gravity&, wouldn't it be gravitation?"

//【諏訪】
<voice name="諏訪" class="諏訪" src="ch04/09100140su">
...
//【判】
<voice name="判" class="判" src="ch04/09100150bn">
"Ohh&, yeah&, yeah&. That's it&."

//【判】
<voice name="判" class="判" src="ch04/09100160bn">
...
[text905]
//【判】
<voice name="判" class="判" src="ch04/09100200bn">
"Apparently&, Shibuya's average GE rate is top-class&, even compared
to the rest of the world&."

//【判】
<voice name="判" class="判" src="ch04/09100210bn">
...
{	Stand("st護_スーツ_通常","sigh", 200, @-150);
	...
	DeleteStand("st護_スーツ_通常_hard", 0, true);}
//【諏訪】
<voice name="諏訪" class="諏訪" src="ch04/09100220su">
"S&, seriously?" 
...
//【諏訪】
<voice name="諏訪" class="諏訪" src="ch04/09100230su">
"It's like the world you see in a sci-fi movie&."

//※諏訪のＳＦ映画好きは後の伏線です
//【判】
<voice name="判" class="判" src="ch04/09100240bn">
...
[text006]
//【諏訪】
<voice name="諏訪" class="諏訪" src="ch04/09100250su">
...
{	Stand("st安二_スーツ_通常","hard", 200, @+150);
	...
	DeleteStand("st安二_スーツ_通常_normal", 0, true);}
//【判】
<voice name="判" class="判" src="ch04/09100260bn">
"That stuff's over my head&."

//【諏訪】
<voice name="諏訪" class="諏訪" src="ch04/09100270su">
"Your explanation makes sense and all&, but&.&.&.&. I'm having a hard
time believing it&."

//【諏訪】
<voice name="諏訪" class="諏訪" src="ch04/09100280su">
"I've never heard of this GE rate thing&."

//【判】
<voice name="判" class="判" src="ch04/09100290bn">
"Don't talk like your ignorance is the prevailing view&."

//◆「刑事」＝デカ、と読んでください
//【判】
<voice name="判" class="判" src="ch04/09100300bn">
...
{	Stand("st護_スーツ_通常","sigh", 200, @-150);
	...
	DeleteStand("st護_スーツ_通常_normal", 0, true);}
//【諏訪】
<voice name="諏訪" class="諏訪" src="ch04/09100310su">
"Haah&, but&.&.&.&." 
...
[text007]
//【諏訪】
<voice name="諏訪" class="諏訪" src="ch04/09100320su">
"For starters&, you haven't given me the most important answer&."

//【諏訪】
<voice name="諏訪" class="諏訪" src="ch04/09100330su">
...
//【判】
<voice name="判" class="判" src="ch04/09100390bn">
...
[text008]
//【諏訪】
<voice name="諏訪" class="諏訪" src="ch04/09100430su">
...
{	Stand("st安二_スーツ_通常","hard", 200, @+150);
	...
	DeleteStand("st安二_スーツ_通常_normal", 0, true);}
//【判】
<voice name="判" class="判" src="ch04/09100440bn">
"Not just giving birth&."

//【判】
<voice name="判" class="判" src="ch04/09100450bn">
"I'm talking about our biorhythms&."

//【判】
<voice name="判" class="判" src="ch04/09100460bn">
...
//【判】
<voice name="判" class="判" src="ch04/09100470bn">
...
{	Stand("st安二_スーツ_通常","pride", 200, @+150);
	...
	DeleteStand("st安二_スーツ_通常_hard", 0, true);}
//【判】
<voice name="判" class="判" src="ch04/09100480bn">
...
{	Stand("st護_スーツ_通常","sigh", 200, @-150);
	...
	DeleteStand("st護_スーツ_通常_normal", 0, true);}
//【諏訪】
<voice name="諏訪" class="諏訪" src="ch04/09100490su">
"I think that's kind of taking it to extremes&."

//【諏訪】
<voice name="諏訪" class="諏訪" src="ch04/09100500su">
...
//【判】
<voice name="判" class="判" src="ch04/09100510bn">
...
[text009]
//【判】
<voice name="判" class="判" src="ch04/09100520bn">
...
//【判】
<voice name="判" class="判" src="ch04/09100620bn">
...
{	Stand("st護_スーツ_通常","sigh", 200, @-150);
	...
	DeleteStand("st護_スーツ_通常_hard", 0, true);}
//【諏訪】
<voice name="諏訪" class="諏訪" src="ch04/09100630su">
...
{	Stand("st安二_スーツ_通常","pride", 200, @+150);
	...
	DeleteStand("st安二_スーツ_通常_hard", 0, true);}
//【判】
<voice name="判" class="判" src="ch04/09100640bn">
...
//【諏訪】
<voice name="諏訪" class="諏訪" src="ch04/09100690su">
"The incidents occur in places where the GE rate is abnormal&.&.&.&.
you mean!?"

//【諏訪】
<voice name="諏訪" class="諏訪" src="ch04/09100700su">
...
{	Stand("st安二_スーツ_通常","hard", 200, @+150);
	...
	DeleteStand("st安二_スーツ_通常_pride", 0, true);}
//【判】
<voice name="判" class="判" src="ch04/09100710bn">
