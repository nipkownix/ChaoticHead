...
c<pre>u</pre>tting down a mere human being was as simple as c<pre>u</pre>tting through jelly&.
	...
	CreateMovie("ムービー", 1000, Center, Middle, false, false, "dx/mvTrack02.ngs");
...
{	CreateSE("SE10","SE_擬音_蛇うごめく_Loop");
	...
	CreateMovie("ムービー", 500, Center, -600, true, false, "dx/mvSword04.ngs");
...
It would be fair to say that the ideals he aimed for had been achieved
together with the completion of Noah II&.
...
{#TIPS_永久機関 = true;}"It's a <FONT incolor="#88abda" outcolor="BLACK">perpetual motion machine</FONT>&."
