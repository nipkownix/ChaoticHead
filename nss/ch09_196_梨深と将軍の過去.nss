...
chapter main
{
	...
	$PreGameName = "boot_‘æ‹ãÍ";

	if($GameStart != 1)
	{
		$GameName = "ch09_196_—œ[‚Æ«ŒR‚Ì‰ß‹";
		$GameContiune = 1;
		Reset();
	}

		ch09_196_—œ[‚Æ«ŒR‚Ì‰ß‹();
}


function ch09_196_—œ[‚Æ«ŒR‚Ì‰ß‹()
{
...
//¦ˆÈ‰ºA‰ñ‘zB‚SÍ–`“ª‚Ì‰ñ‘z‚ÌÚ×”Å
//‚a‚f//”’
//‚r‚d//”g‚Ì‰¹
...
//Ÿ—œ[‚Íƒeƒ“ƒVƒ‡ƒ“’á‚ß
//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600010ri">
"&.&.&.&.Is this the sky?"

//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600020ri">
"That sky--"

//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600030ri">
...
//‚a‚f//ŠC‚ÆÂ‚¢‹ó
	CreateTextureEX("back03", 100, 0, 0, "cg/bg/bg113_01_6_ŠC‚ÆÂ‚¢‹ó_a.jpg");
...
[text002]
//y«ŒRz
<voice name="«ŒR" class="«ŒR" src="ch09/19600040jn">
"Because someone wished so&."

//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600050ri">
"Not me&.&.&.&."

//y«ŒRz
<voice name="«ŒR" class="«ŒR" src="ch09/19600060jn">
"I wished for it&."

//y«ŒRz
<voice name="«ŒR" class="«ŒR" src="ch09/19600070jn">
...
//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600160ri">
"I've never seen the real sky&."

//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600170ri">
"When the personality that is me was born&, I was already shut up in a
dark room&."

//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600180ri">
"Both inside my heart&, and outside it&, there was nothing but
darkness&."

//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600190ri">
"They'll never let me out&."

//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600200ri">
"&.&.&.&.&.&.&.&.&."

//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600210ri">
"I tried to die just now&."

//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600220ri">
"To make my heart kill itself&."

//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600230ri">
"I think every other me up till now did the same thing&."

//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600240ri">
"But since you've gone so far as to bring the sky to me&,"

//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600250ri">
"Would it be okay if I carved this sce<pre>n</pre>e into my memory? So the next
me can imagine the same thing&."

//y«ŒRz
<voice name="«ŒR" class="«ŒR" src="ch09/19600260jn">
"Do you want to die?"

//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600270ri">
"Yeah&.&.&.&."

//y«ŒRz
<voice name="«ŒR" class="«ŒR" src="ch09/19600280jn">
"Don't you think you'd like to see the real sky?"

//ŸØ‚È‚¢ƒuƒŒƒX
//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600290ri">
"&.&.&.&.&.&.&.&.&."

//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600300ri">
"&.&.&.&.Say&."

//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600310ri">
"Is there really a sky out there?"

//y«ŒRz
<voice name="«ŒR" class="«ŒR" src="ch09/19600320jn">
"It's there&."

//y«ŒRz
<voice name="«ŒR" class="«ŒR" src="ch09/19600330jn">
"But the real sky is much more dirty than this one&."

//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600340ri">
"Where is it?"

//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600350ri">
"Where is that sky?"

//y«ŒRz
<voice name="«ŒR" class="«ŒR" src="ch09/19600360jn">
"Anywhere you wish it to be&."

//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600370ri">
"Is it okay&, to wish&.&.&.&.?"

//y«ŒRz
<voice name="«ŒR" class="«ŒR" src="ch09/19600380jn">
"Of course&."

//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600390ri">
"How do I wish for it?"

//y«ŒRz
<voice name="«ŒR" class="«ŒR" src="ch09/19600400jn">
"Light is made up of waves in an electromagnetic field&. Human sight
detects its oscillations as color&."

//y«ŒRz
<voice name="«ŒR" class="«ŒR" src="ch09/19600410jn">
"Try applying the color you desire to your own dead spots&. If you
do--"

//y«ŒRz
<voice name="«ŒR" class="«ŒR" src="ch09/19600420jn">
"You can create the color of the world you desire&."

//y«ŒRz
<voice name="«ŒR" class="«ŒR" src="ch09/19600430jn">
...
//‚a‚f//•aº
	...
	CreateBG(100, 1000, 0, 0, "cg/bg/bg190_01_1_•aºÂ‹ó_a.jpg");
...
[text005]
//yµŠCz
<voice name="µŠC" class="µŠC" src="ch09/19600440na">
"Bro&, you have a visitor&."

//Ÿ‚©‚ç‚©‚¤‚æ‚¤‚ÉB¬º
//yµŠCz
<voice name="µŠC" class="µŠC" src="ch09/19600450na">
"Hey&, hey&, who is she? Your girlfriend? When did you meet?"

//Ÿ‚©‚ç‚©‚¤‚æ‚¤‚ÉB¬º
//yµŠCz
<voice name="µŠC" class="µŠC" src="ch09/19600460na">
"Way to go&, Bro&."

//y«ŒRz
<voice name="«ŒR" class="«ŒR" src="ch09/19600470jn">
"&.&.&.&.&.&.&.&.&."

//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600480ri">
"&.&.&.&.We meet again&." 
...
//y«ŒRz
<voice name="«ŒR" class="«ŒR" src="ch09/19600490jn">
"Were you able to see the true sky?"

//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600500ri">
"Yeah&."

//yµŠCz
<voice name="µŠC" class="µŠC" src="ch09/19600510na">
"Ah&, I know&." 
...
//yµŠCz
<voice name="µŠC" class="µŠC" src="ch09/19600520na">
...
//‚r‚d//ƒhƒA•Â‚ß‚é
	...
	CreateSE("SE01","SE_“úí_•aºƒhƒA_•Â‚Ü‚é");
...
//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600530ri">
"How long have you been hospitalized&, Takumi?"

//y«ŒRz
<voice name="«ŒR" class="«ŒR" src="ch09/19600540jn">
"About five years&."

//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600550ri">
"Do you have any plans for being discharged?"

//y«ŒRz
<voice name="«ŒR" class="«ŒR" src="ch09/19600560jn">
"No&. I think my remaining lifespan&.&.&.&. is about another two
years&."

//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600570ri">
"&.&.&.&.&.&.&.&.&."

//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600580ri">
"Thanks to you&.&.&.&. I was able to try harder&."

//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600590ri">
...
//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600600ri">
"And then&, all of a sudden&, they let me out&. Although it might be
more proper to say that they'd simply finished up with me&."

//y«ŒRz
<voice name="«ŒR" class="«ŒR" src="ch09/19600610jn">
"I see&."

//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600620ri">
"You saved me&."

//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600630ri">
"So this time&, I want to become your strength&."

//y«ŒRz
<voice name="«ŒR" class="«ŒR" src="ch09/19600640jn">
"You don't have to worry about it&."

//y«ŒRz
<voice name="«ŒR" class="«ŒR" src="ch09/19600650jn">
"You don't have to come out of your way to see me&."

//y«ŒRz
<voice name="«ŒR" class="«ŒR" src="ch09/19600660jn">
"I want you to live a normal life from now on&."

//ŸØ‚È‚¢Î‚İ‚ğ•‚‚©‚×‚é
//y—œ[z
<voice name="—œ[" class="—œ[" src="ch09/19600670ri">
