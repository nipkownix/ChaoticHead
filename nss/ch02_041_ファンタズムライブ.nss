...
//ＶＦ//マイク
//【あやせ】
<voice name="あやせ" class="あやせ" src="ch02/04100010ay">
"Today&.&.&.&. I feel far better than usual&.&.&.&.&."

//【あやせ】
<voice name="あやせ" class="あやせ" src="ch02/04100020ay">
"I can hear the voices clearly&."

//【あやせ】
<voice name="あやせ" class="あやせ" src="ch02/04100030ay">
...
//【あやせ】
<voice name="あやせ" class="あやせ" src="ch02/04100040ay">
...
//【あやせ】
<voice name="あやせ" class="あやせ" src="ch02/04100050ay">
...
//【あやせ】
<voice name="あやせ" class="あやせ" src="ch02/04100060ay">
...
//【あやせ】
<voice name="あやせ" class="あやせ" src="ch02/04100070ay">
"And so I sing&.&.&.&."

//【あやせ】
<voice name="あやせ" class="あやせ" src="ch02/04100080ay">
...
//【あやせ】
<voice name="あやせ" class="あやせ" src="ch02/04100090ay">
"Next is our third song&.&.&.&."

//挿入歌タイトルはこれで確定です
//【あやせ】
<voice name="あやせ" class="あやせ" src="ch02/04100100ay">
...
//	SoundPlay("@CH_INS_FES_ライヴ",0,1000,true);
	...
	$杭打ち = 1;
	CreateSound("杭を打て１", SE, "sound/bgm/CH_INS_FES_ライヴ");
	SoundPlay("杭を打て１",0,1,false);
	SetStream("杭を打て１", 12000);
...
//※以上、歌詞
	...
	if($杭打 < 31000)
	{
		...
		$杭打ち = 2;
		CreateSound("杭を打て２", SE, "sound/bgm/CH_INS_FES_ライヴ");
		SetVolume("杭を打て２", 0, 0, NULL);
		SetAlias("杭を打て２", "杭を打て２");
		SoundPlay("杭を打て２",0,1,false);
		SetStream("杭を打て２", 33000);
...
At the end&, she repeated the chorus over and over&.
	...
	if($杭打 < 284000)
	{
		...
		CreateSound("杭を打て３", SE, "sound/bgm/CH_INS_FES_ライヴ");
		SetVolume("杭を打て３", 0, 0, NULL);
		SetAlias("杭を打て３", "杭を打て３");
		SoundPlay("杭を打て３",0,1,false);
		SetStream("杭を打て３", 286000);
