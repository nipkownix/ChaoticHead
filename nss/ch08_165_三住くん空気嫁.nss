...
//yOZz
<voice name="OZ" class="OZ" src="voice/ch08/16500010mi">
"I don't give a damn about Kishimoto anymore&.&.&."

//yOZz
<voice name="OZ" class="OZ" src="voice/ch08/16500020mi">
"You know&, Taku&, up until now&,
My policy was to let anything slide as long as the girl's c<pre>u</pre>te&."

//yOZz
<voice name="OZ" class="OZ" src="voice/ch08/16500030mi">
"But I was wrong&.
I can't face up to such a severe head case&.&.&."

//yOZz
<voice name="OZ" class="OZ" src="voice/ch08/16500040mi">
"I'm just gonna stay true to myself and go after Kozue-chan&, dude&."

//y‘ñ–¤z
<voice name="‘ñ–¤" class="‘ñ–¤" src="voice/ch08/16500050ta">
"&.&.&.&.&.&.&."
...
//yOZz
<voice name="OZ" class="OZ" src="voice/ch08/16500060mi">
"You're amazing&. For real&."

//yOZz
<voice name="OZ" class="OZ" src="voice/ch08/16500070mi">
...
[text002]
//yOZz
<voice name="OZ" class="OZ" src="voice/ch08/16500090mi">
"Heeeey&, Rimi&."
...
//y—œ[z
<voice name="—œ[" class="—œ[" src="voice/ch08/16500100ri">
"I finally found you&."
...
//y—œ[z
<voice name="—œ[" class="—œ[" src="voice/ch08/16500110ri">
...
//yOZz
<voice name="OZ" class="OZ" src="voice/ch08/16500120mi">
"Where were you moseying around?"

//y—œ[z
<voice name="—œ[" class="—œ[" src="voice/ch08/16500130ri">
...
//Ÿ‚í‚´‚Æ‚ç‚µ‚­
//y—œ[z
<voice name="—œ[" class="—œ[" src="voice/ch08/16500140ri">
...
{	Stand("bu‘å•ã_§•_’Êí","worry", 200, @250);
	...
	DeleteStand("bu‘å•ã_§•_’Êí_sigh", 0, false);}
//yOZz
<voice name="OZ" class="OZ" src="voice/ch08/16500150mi">
...
//y—œ[z
<voice name="—œ[" class="—œ[" src="voice/ch08/16500160ri">
"Aha&. So I did&."
...
//y—œ[z
<voice name="—œ[" class="—œ[" src="voice/ch08/16500170ri">
...
[text003]
//yOZz
<voice name="OZ" class="OZ" src="voice/ch08/16500180mi">
...
//y—œ[z
<voice name="—œ[" class="—œ[" src="voice/ch08/16500190ri">
"Eh&.&.&.?"
...
//y—œ[z
<voice name="—œ[" class="—œ[" src="voice/ch08/16500200ri">
...
//yOZz
<voice name="OZ" class="OZ" src="voice/ch08/16500210mi">
...
//ŸƒVƒ…ƒ“‚Æ‚·‚é
//y—œ[z
<voice name="—œ[" class="—œ[" src="voice/ch08/16500220ri">
...
//y—œ[z
<voice name="—œ[" class="—œ[" src="voice/ch08/16500230ri">
"Did you see it too&, Taku?"

//y‘ñ–¤z
<voice name="‘ñ–¤" class="‘ñ–¤" src="voice/ch08/16500240ta">
"Er&.&.&. um&.&.&."

//yOZz
<voice name="OZ" class="OZ" src="voice/ch08/16500250mi">
...
{	SetTrigger("‚R‚W");
	...
	DeleteStand("bu—œ[_§•_³–Ê_sad", 0, false);}
//y—œ[z
<voice name="—œ[" class="—œ[" src="voice/ch08/16500260ri">
...
//yOZz
<voice name="OZ" class="OZ" src="voice/ch08/16500290mi">
...
//y—œ[z
<voice name="—œ[" class="—œ[" src="voice/ch08/16500300ri">
"Um&, well&, you see&,"
