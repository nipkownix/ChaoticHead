...
//■第８章【Ir2】
	...
	CreateMovie("章イン", 25000, 0, 0, false, true, "dx/mvG.ngs");
	Request("章イン", Lock);
...
//【百瀬】
<voice name="百瀬" class="百瀬" src="ch08/15400010mm">
...
//【百瀬】
<voice name="百瀬" class="百瀬" src="ch08/15400020mm">
...
//【判】
<voice name="判" class="判" src="ch08/15400030bn">
...
//ため息
//【百瀬】
<voice name="百瀬" class="百瀬" src="ch08/15400070mm">
"Haa&.&.&.&. unbelievable&.&.&.&. you amaze me so much&, I've got
nothing left to say&."

//【判】
<voice name="判" class="判" src="ch08/15400080bn">
"So&, if you've called me out like this&,
I guess you managed to contact 'her'?"

//【百瀬】
<voice name="百瀬" class="百瀬" src="ch08/15400090mm">
"She's here now&."

//【判】
<voice name="判" class="判" src="ch08/15400100bn">
"Way to go&, Momo-chan&."
...
//【判】
<voice name="判" class="判" src="ch08/15400110bn">
...
//【百瀬】
<voice name="百瀬" class="百瀬" src="ch08/15400120mm">
...
//【判】
<voice name="判" class="判" src="ch08/15400130bn">
"It&, it was a joke&."
...
//【百瀬】
<voice name="百瀬" class="百瀬" src="ch08/15400140mm">
...
//【優愛】
<voice name="優愛" class="優愛" src="ch08/15400150yu">
"Ah&, no&. I'm&.&.&.&. fine&.&.&.&."
...
//【判】
<voice name="判" class="判" src="ch08/15400160bn">
"Kusunoki Yua-san&, correct?"

//【優愛】
<voice name="優愛" class="優愛" src="ch08/15400170yu">
"Ye&, yes&.&.&.&."

//◆美愛＝みあ
//【判】
<voice name="判" class="判" src="ch08/15400180bn">
...
{	Stand("st安二_スーツ_通常","pride", 200, @200);
	...
	DeleteStand("st安二_スーツ_通常_normal", 200, false);}
//【判】
<voice name="判" class="判" src="ch08/15400190bn">
"Well&, no need to be so tense&."

//【判】
<voice name="判" class="判" src="ch08/15400200bn">
...
//【判】
<voice name="判" class="判" src="ch08/15400210bn">
...
//【判】
<voice name="判" class="判" src="ch08/15400220bn">
"Yua-chan&, what do you think about your sister's death?"

//◆ブレス
//【優愛】
<voice name="優愛" class="優愛" src="ch08/15400230yu">
"&.&.&.&.&.&.&.&.&."

//◆小声でたしなめる
//【百瀬】
<voice name="百瀬" class="百瀬" src="ch08/15400240mm">
"Hey&, Ban-chan&.&.&.&.!"
...
//【判】
<voice name="判" class="判" src="ch08/15400250bn">
"No&, my bad&. It's like an occupational disease&."

//【判】
<voice name="判" class="判" src="ch08/15400260bn">
...
//【判】
<voice name="判" class="判" src="ch08/15400270bn">
...
//◆怒る
//【百瀬】
<voice name="百瀬" class="百瀬" src="ch08/15400280mm">
"Ban-chan!"
...
//【優愛】
<voice name="優愛" class="優愛" src="ch08/15400290yu">
"No&, it's fine&.&.&.&."
...
//【優愛】
<voice name="優愛" class="優愛" src="ch08/15400300yu">
...
//◆ため息
//【百瀬】
<voice name="百瀬" class="百瀬" src="ch08/15400310mm">
"&.&.&.&.&.&.&.&.&."
...
//【判】
<voice name="判" class="判" src="ch08/15400320bn">
...
//【判】
<voice name="判" class="判" src="ch08/15400330bn">
...
//【優愛】
<voice name="優愛" class="優愛" src="ch08/15400360yu">
...
//【優愛】
<voice name="優愛" class="優愛" src="ch08/15400370yu">
"At first&.&.&.&. the day we received notice of what happened to
Mia-chan&, they wept&."

//【優愛】
<voice name="優愛" class="優愛" src="ch08/15400380yu">
"Mom and Dad both seemed to be having a very hard time&."

//【優愛】
<voice name="優愛" class="優愛" src="ch08/15400390yu">
...
//【優愛】
<voice name="優愛" class="優愛" src="ch08/15400400yu">
"In a single day&.&.&.&."

//【優愛】
<voice name="優愛" class="優愛" src="ch08/15400410yu">
"I had no idea what was going on&.&.&.&."

//【優愛】
<voice name="優愛" class="優愛" src="ch08/15400420yu">
"I thought maybe the two of them were trying to forget about
Mia-chan&.&.&.&."

//【優愛】
<voice name="優愛" class="優愛" src="ch08/15400430yu">
"Then Dad&.&.&.&. he laughed&.&.&.&."

//【優愛】
<voice name="優愛" class="優愛" src="ch08/15400440yu">
"And said 'you never had a sister'&.&.&.&."

//【優愛】
<voice name="優愛" class="優愛" src="ch08/15400450yu">
"Even if I showed them the clothes and shoes Mia-chan had left
behind&, they wouldn't take any notice of it&."

//【優愛】
<voice name="優愛" class="優愛" src="ch08/15400460yu">
"They said they'd bought them as back-ups for my sake&."

//【優愛】
<voice name="優愛" class="優愛" src="ch08/15400470yu">
"Mom and Dad went on averting their eyes from the news and from
everything the police told us&.&.&.&."

//【優愛】
<voice name="優愛" class="優愛" src="ch08/15400480yu">
"They were attempting to erase Mia-chan from their memories&.&.&.&."

//【百瀬】
<voice name="百瀬" class="百瀬" src="ch08/15400490mm">
...
{	Stand("st安二_スーツ_通常","normal", 200, @200);
	...
	DeleteStand("st安二_スーツ_通常_hard", 200, false);}
//【判】
<voice name="判" class="判" src="ch08/15400500bn">
...
//【優愛】
<voice name="優愛" class="優愛" src="ch08/15400510yu">
"Mia-chan and I were identical twins&, and we looked exactly the same
on the outside&, but&.&.&.&."

//【優愛】
<voice name="優愛" class="優愛" src="ch08/15400520yu">
"My parents disliked her--my younger sister&.&.&.&."

//【優愛】
<voice name="優愛" class="優愛" src="ch08/15400530yu">
...
//◆泣き
//【優愛】
<voice name="優愛" class="優愛" src="ch08/15400540yu">
"In the end&.&.&.&. I let Mia-chan's kindness spoil me&.&.&.&. until
now&.&.&.&. only I was happy&.&.&.&."

//◆泣き
//【優愛】
<voice name="優愛" class="優愛" src="ch08/15400550yu">
...
//◆泣き
//【優愛】
<voice name="優愛" class="優愛" src="ch08/15400560yu">
"I should have&.&.&.&. died in her stead&.&.&.&."

//◆泣き
//【優愛】
<voice name="優愛" class="優愛" src="ch08/15400570yu">
"And on top of everything else&.&.&.&. to have our parents ultimately
forget her existence itself&.&.&.&."

//◆泣き
//【優愛】
<voice name="優愛" class="優愛" src="ch08/15400580yu">
...
//【百瀬】
<voice name="百瀬" class="百瀬" src="ch08/15400590mm">
"And so it seems that Yua-chan was investigating the incident all by
herself&."

//【百瀬】
<voice name="百瀬" class="百瀬" src="ch08/15400600mm">
"In order to find out what on earth had happened to Mia-chan&."

//【判】
<voice name="判" class="判" src="ch08/15400610bn">
"It must be really hard&."

//【百瀬】
<voice name="百瀬" class="百瀬" src="ch08/15400620mm">
"And she pinpointed a single person&."

//【判】
<voice name="判" class="判" src="ch08/15400630bn">
"&.&.&.&.?"

Arm around Yua's shoulders&, Momose gave Ban a look&.

//【百瀬】
<voice name="百瀬" class="百瀬" src="ch08/15400640mm">
"&.&.&.&.Nishijou Takumi-kun&."

//【判】
<voice name="判" class="判" src="ch08/15400650bn">
"I see&."
...
{	Stand("st安二_スーツ_通常","normal", 200, @200);
	...
	DeleteStand("st安二_スーツ_通常_hard", 200, false);}
//【判】
<voice name="判" class="判" src="ch08/15400660bn">
...
//【判】
<voice name="判" class="判" src="ch08/15400670bn">
"Could that have been you&, Yua-chan?"

Yua gave him an apologetic nod&.

//【判】
<voice name="判" class="判" src="ch08/15400680bn">
...
[text009]
//【判】
<voice name="判" class="判" src="ch08/15400690bn">
...
[text010]
//【判】
<voice name="判" class="判" src="ch08/15400700bn">
"Hello&. What's up?"

//ＶＦ//電話の声
//【諏訪】
<voice name="諏訪" class="諏訪" src="ch08/15400710su">
"Sempai! It's the seventh!"

//【判】
<voice name="判" class="判" src="ch08/15400720bn">
"What?"
...
//ＶＦ//電話の声
//【諏訪】
<voice name="諏訪" class="諏訪" src="ch08/15400730su">
"The seventh New-Gen incident happened!"

{	MusicStart("@CH01", 3000, 1000, 0, 1000, null, true);}
//【判】
<voice name="判" class="判" src="ch08/15400740bn">
"&.&.&.&.!"
