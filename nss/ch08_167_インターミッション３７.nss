...
//【判】
<voice name="判" class="判" src="ch08/16700010bn">
...
//【優愛】
<voice name="優愛" class="優愛" src="ch08/16700020yu">
"Eh&, but didn't Momose-san 
ask you to buy a Gero-froggy for her&.&.&.&.?"

//【判】
<voice name="判" class="判" src="ch08/16700030bn">
...
[text002]
//【判】
<voice name="判" class="判" src="ch08/16700040bn">
"Some~how&, it feels like someone's watching me&."

//【判】
<voice name="判" class="判" src="ch08/16700050bn">
...
//【優愛】
<voice name="優愛" class="優愛" src="ch08/16700060yu">
"Ah&, it's the same for me&."

//【優愛】
<voice name="優愛" class="優愛" src="ch08/16700070yu">
...
//【判】
<voice name="判" class="判" src="ch08/16700080bn">
"Oh&, so it wasn't just me&."

//【判】
<voice name="判" class="判" src="ch08/16700090bn">
...
//【優愛】
<voice name="優愛" class="優愛" src="ch08/16700100yu">
...
//【判】
<voice name="判" class="判" src="ch08/16700110bn">
...
//【判】
<voice name="判" class="判" src="ch08/16700120bn">
...
//【優愛】
<voice name="優愛" class="優愛" src="ch08/16700130yu">
...
{	Stand("bu安二_スーツ_通常","hard", 250, @210);
	...
	DeleteStand("bu安二_スーツ_通常_normal", 0, false);}
//【判】
<voice name="判" class="判" src="ch08/16700140bn">
"There aren't too many customers&.&.&.&."

//【判】
<voice name="判" class="判" src="ch08/16700150bn">
...
//【判】
<voice name="判" class="判" src="ch08/16700200bn">
...
//◆しゃぁせぇ＝いらっしゃいませ
//【ショップ店員】
<voice name="ショップ店員" class="ショップ店員" src="ch08/16700210ss">
"Welcome&." 
...
//【ショップ店員】
<voice name="ショップ店員" class="ショップ店員" src="ch08/16700220ss">
"A present for your daughter?"

{	Stand("bu安二_スーツ_通常","pride", 250, @210);
	FadeStand("bu安二_スーツ_通常_pride", 500, true);}
//【判】
<voice name="判" class="判" src="ch08/16700230bn">
"Yeah&, pretty much&."

//【判】
<voice name="判" class="判" src="ch08/16700240bn">
"Cause she said she wanted it no matter what&."

//【判】
<voice name="判" class="判" src="ch08/16700250bn">
...
{	Stand("bu安二_スーツ_通常","normal", 250, @210);
	...
	DeleteStand("bu安二_スーツ_通常_pride", 0, false);}
//【判】
<voice name="判" class="判" src="ch08/16700260bn">
"More importantly&, I'm interested in these frogs&. Could you tell me
a little about them?"

//【判】
<voice name="判" class="判" src="ch08/16700270bn">
"Are these Gecko-froggies really all that popular?"

//【ショップ店員】
<voice name="ショップ店員" class="ショップ店員" src="ch08/16700280ss">
...
{	Stand("bu安二_スーツ_通常","pride", 250, @210);
	...
	DeleteStand("bu安二_スーツ_通常_normal", 0, false);}
//【判】
<voice name="判" class="判" src="ch08/16700290bn">
"Ahh&, Gepu-froggy&. Do the new ones always come out on the weekend?"

//【ショップ店員】
<voice name="ショップ店員" class="ショップ店員" src="ch08/16700300ss">
"Seriously&, I'm tellin' ya&, it's Gero-froggy&."

//【ショップ店員】
<voice name="ショップ店員" class="ショップ店員" src="ch08/16700310ss">
"And&, like&, don't say the new ones&. They're 'new-froggies&.'"

//【ショップ店員】
<voice name="ショップ店員" class="ショップ店員" src="ch08/16700320ss">
...
//【ショップ店員】
<voice name="ショップ店員" class="ショップ店員" src="ch08/16700330ss">
...
{	Stand("bu安二_スーツ_通常","normal", 250, @210);
	...
	DeleteStand("bu安二_スーツ_通常_pride", 0, false);}
//【判】
<voice name="判" class="判" src="ch08/16700340bn">
"It says on the label that it's made in China&, but d'you know who the
maker is?"

//【ショップ店員】
<voice name="ショップ店員" class="ショップ店員" src="ch08/16700350ss">
"Hah? Maker?"

//【ショップ店員】
<voice name="ショップ店員" class="ショップ店員" src="ch08/16700360ss">
"Look&, Gero-froggy doesn't have a parent brand or whatevs&.
Gero-froggy is just Gero-froggy&, ya know? Doesn't it end there?"

//【ショップ店員】
<voice name="ショップ店員" class="ショップ店員" src="ch08/16700370ss">
"You&, like&, way don't get it&, Pops&."

//【ショップ店員】
<voice name="ショップ店員" class="ショップ店員" src="ch08/16700380ss">
...
{	Stand("bu安二_スーツ_通常","hard", 250, @210);
	...
	DeleteStand("bu安二_スーツ_通常_normal", 0, false);}
//【判】
<voice name="判" class="判" src="ch08/16700390bn">
"&.&.&.&.&.&.&.&.&."
...
//【判】
<voice name="判" class="判" src="ch08/16700400bn">
"Geez&, talk about not training your employees&."

//【判】
<voice name="判" class="判" src="ch08/16700410bn">
"Kids today can't even carry on a proper conversation&."

//【判】
<voice name="判" class="判" src="ch08/16700420bn">
...
//◆苦笑
//【優愛】
<voice name="優愛" class="優愛" src="ch08/16700430yu">
"&.&.&.&.In&, indeed&."
...
//【優愛】
<voice name="優愛" class="優愛" src="ch08/16700440yu">
"Ah&.&.&.&."
...
//【判】
<voice name="判" class="判" src="ch08/16700470bn">
...
//【優愛】
<voice name="優愛" class="優愛" src="ch08/16700480yu">
...
//【判】
<voice name="判" class="判" src="ch08/16700490bn">
...
//【優愛】
<voice name="優愛" class="優愛" src="ch08/16700500yu">
"Eh&, no&, I'm&.&.&.&."
...
//◆※シンコー＝神光
//【判】
<voice name="判" class="判" src="ch08/16700510bn">
...
//【優愛】
<voice name="優愛" class="優愛" src="ch08/16700520yu">
"Er&, I haven't&.&.&.&."
...
//【判】
<voice name="判" class="判" src="ch08/16700530bn">
