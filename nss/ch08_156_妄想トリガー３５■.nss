...
//◆切ないブレス
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600010ri">
"&.&.&.&.&.&.&.&.&."
...
//◆寂しそう
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600020ri">
...
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600030ri">
...
[text002]
//【拓巳】
<voice name="拓巳" class="拓巳" src="ch08/15600040ta">
...
//【星来】
<voice name="星来" class="星来" src="ch08/15600160se">
"You've got mail~&, dummy ♪"

//【拓巳】
<voice name="拓巳" class="拓巳" src="ch08/15600170ta">
"!?"
...
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600180ri">
"Wha&, what was that?"
...
[text004]
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600190ri">
"Hm~m&, ahh&, is that so&."

//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600200ri">
...
//【拓巳】
<voice name="拓巳" class="拓巳" src="ch08/15600210ta">
"Wai&, wai&.&.&.&.&."
...
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600220ri">
"Are you worried about your little sister?"

//【拓巳】
<voice name="拓巳" class="拓巳" src="ch08/15600230ta">
"Eh&.&.&.&."

//【拓巳】
<voice name="拓巳" class="拓巳" src="ch08/15600240ta">
"Ho&, how do you know that?"

Even though I hadn't asked her for a word of advice about Nanami yet&.

//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600250ri">
"Cause you were muttering to yourself about it&."

//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600260ri">
"Hey&, who's more important to you&, me or your sister?"

//【拓巳】
<voice name="拓巳" class="拓巳" src="ch08/15600270ta">
"&.&.&.&.&.&.&.&.&.&."
...
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600280ri">
...
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600290ri">
...
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600300ri">
"Please&. Look at me&.&.&.&."

//【拓巳】
<voice name="拓巳" class="拓巳" src="ch08/15600310ta">
...
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600320ri">
"I'm looking&."
...
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600330ri">
...
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600340ri">
...
//【拓巳】
<voice name="拓巳" class="拓巳" src="ch08/15600350ta">
"St&, stop&.&.&.&.!"
...
[text006]
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600360ri">
"Eh? Stop what?"
...
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600370ri">
"Taku? You don't look well&. Is something wrong?"

//【拓巳】
<voice name="拓巳" class="拓巳" src="ch08/15600380ta">
"Ah&, no&.&.&.&."
...
{	CreateTextureEX("背景１", 100, 0, 0, "cg/bg/bg000_02_1_チャットサンプル_a.jpg");
	Fade("背景１", 0, 1000, null, true);}
//【星来】
<voice name="星来" class="星来" src="ch08/15600390se">
"You've got mail~&, dummy ♪"

//【拓巳】
<voice name="拓巳" class="拓巳" src="ch08/15600400ta">
"!?"
...
{	CreateTextureEX("背景２", 100, 0, 0, "cg/bg/bg026_02_1_拓巳部屋_a.jpg");
	...
	FadeStand("bu梨深_制服_通常_shock", 200, true);}
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600410ri">
"Wha&, what was that?"

//【拓巳】
<voice name="拓巳" class="拓巳" src="ch08/15600420ta">
"Ah&, no&.&.&.&."
...
[text007]
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600430ri">
...
//【梨深】
//<voice name="梨深" class="梨深" src="ch08/15600770ri">
<voice name="梨深" class="梨深" src="ch08/15600440ri">
...
//【拓巳】
<voice name="拓巳" class="拓巳" src="ch08/15600450ta">
"Wai&.&.&.&."
...
//【梨深】
//<voice name="梨深" class="梨深" src="ch08/15600760ri">
<voice name="梨深" class="梨深" src="ch08/15600460ri">
"Eii&, take that&. Ahaha&."
...
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600470ri">
"Hey&, hey&, let's do something more fun--"

//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600480ri">
"Or else I'm really gonna c<pre>u</pre>t you&."

//【拓巳】
<voice name="拓巳" class="拓巳" src="ch08/15600490ta">
...
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600500ri">
...
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600510ri">
...
//【拓巳】
<voice name="拓巳" class="拓巳" src="ch08/15600520ta">
...
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600530ri">
...
[text008]
//【星来】
<voice name="星来" class="星来" src="ch08/15600540se">
"You've got mail~&, dummy ♪"

//【拓巳】
<voice name="拓巳" class="拓巳" src="ch08/15600550ta">
"!?"
...
{	CreateTextureEX("背景２", 100, 0, 0, "cg/bg/bg026_02_1_拓巳部屋_a.jpg");
	...
	FadeStand("bu梨深_制服_通常_shock", 200, true);}
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600560ri">
"Wha&, what was that?"

//【拓巳】
<voice name="拓巳" class="拓巳" src="ch08/15600570ta">
"Ah&, no&.&.&.&."
...
<PRE @box01>
[text015]
Neidhardt: What're you saying? (<--too lazy to {#TIPS_ＡＡ =
true;}c&p ASCII art)
</PRE>
	SetChat($SYSTEM_present_preprocess,$SYSTEM_present_text,#FFFFFF);
	SoundChat(1,1,key);
...
[text021]
//【拓巳】
<voice name="拓巳" class="拓巳" src="ch08/15600580ta">
"&.&.&.&.!"

//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600590ri">
"What's the matter?"
...
//◆呆然
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600600ri">
...
{	CreateTextureEX("背景２", 100, 0, 0, "cg/bg/bg026_02_1_拓巳部屋_a.jpg");
	...
	Delete("box01");}
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600610ri">
"Taku&.&.&.&. you have nothing to worry about&."

//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600620ri">
"There's nothing for you to be scared of&."

//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600630ri">
...
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600640ri">
"It's all just paranoia on your part&. Okay?"

//【拓巳】
<voice name="拓巳" class="拓巳" src="ch08/15600650ta">
"&.&.&.&.&.&.&.&.&."
...
<PRE @box03>
[text900]
　　　　 <FONT size="26" incolor="#ff0000">【New-Gen】3 corpses
divided in half at the torso in Shibuya「DQN on their
foreheads」★３</FONT>
</PRE>
...
//徒歩：なんちゅうていさんに交渉中
	...
	CreateMovie("砂嵐", 200, 0, 0, true, false, "dx/mv砂嵐.ngs");	
...
[text023]
//【キャスターＡ】
<voice name="キャスターＡ" class="キャスターＡ" src="ch08/15600660ka">
...
//【キャスターＡ】
<voice name="キャスターＡ" class="キャスターＡ" src="ch08/15600670ka">
...
//【キャスターＡ】
<voice name="キャスターＡ" class="キャスターＡ" src="ch08/15600680ka">
...
//【キャスターＡ】
<voice name="キャスターＡ" class="キャスターＡ" src="ch08/15600690ka">
...
//【キャスターＡ】
<voice name="キャスターＡ" class="キャスターＡ" src="ch08/15600700ka">
...
//【拓巳】
<voice name="拓巳" class="拓巳" src="ch08/15600710ta">
"It&, it's them&.&.&.&."

//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600720ri">
"You know them?"

//【拓巳】
<voice name="拓巳" class="拓巳" src="ch08/15600730ta">
...
//◆しゅーりょー＝終了
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600740ri">
"Allll doooone&."
...
//◆優しく
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600750ri">
"Calm down&."
...
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600780ri">
"More importantly&, I'm hungry&."

//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600790ri">
...
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600800ri">
...
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600810ri">
...
{	Stand("bu梨深_制服_通常","normal", 200, @50);
	...
	DeleteStand("bu梨深_制服_通常_happy", 200, false);}
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600820ri">
...
{	Stand("bu梨深_制服_通常","smile", 200, @50);
	...
	DeleteStand("bu梨深_制服_通常_normal", 200, false);}
//【梨深】
<voice name="梨深" class="梨深" src="ch08/15600830ri">
