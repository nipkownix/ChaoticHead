...
//ＢＧ//拓巳の部屋
	...
	CreateTextureEX("背景４", 150, 0, -150, "chaotic/bg/bg120_01_3_PC画面その目_a.jpg");
	Zoom("背景４", 0, 2000, 2000, null, true);
	CreateTextureEX("背景３", 100, 0, 0, "chaotic/bg/bg120_01_3_PC画面その目_a.jpg");
...
//おがみ：画像ダミーです。上記内容とは食い違っています。
	...
	CreateTextureEX("背景１", 100, 0, 0, "chaotic/bg/bg044_04_1_ワープロ文章_a.jpg");
