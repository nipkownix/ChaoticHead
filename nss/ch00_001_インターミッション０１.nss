...
function ch00_001_インターミッション０１()
{
	...
	CreateMovie("雨１", 100, 0, 0, true, false, "dx/mv雨01.ngs");
	Request("雨１", AddRender);

//	CreateMovie("回想", 900, Center, Middle, true, false, "dx/mvフリッカー.ngs");
...
<PRE box10>
[text001]
<voice name="拓巳" class="拓巳" src="ch01/00100010ta" mode="off">
//視線が、空から降ってくる。
...
<PRE box10>
[text501]
<voice name="拓巳" class="拓巳" src="ch01/00100020ta" mode="off">
//その瞳は、いつも僕を見つめていて。
...
<voice name="拓巳" class="拓巳" src="ch01/00100030ta" mode="off">
...
<voice name="拓巳" class="拓巳" src="ch01/00100040ta" mode="off">
//雨のように僕へと降り注ぐ。
...
<PRE box10>
[text601]
<voice name="拓巳" class="拓巳" src="ch01/00100050ta" mode="off">
//――僕を、見るな。
― Don't look at me&.
{$待ち時間 = RemainTime ("タクミ１");
$待ち時間 += 2000;
...
<PRE box10>
[text003]
<voice name="拓巳" class="拓巳" src="ch01/00100060ta" mode="off">
...
<PRE box10>
[text503]
<voice name="拓巳" class="拓巳" src="ch01/00100070ta" mode="off">
It's horribly cold&.&.&.&.&.&.
{$待ち時間 = RemainTime ("タクミ１");
$待ち時間 += 2000;
WaitKey($待ち時間);}
...
<PRE box10>
[text603]
<voice name="拓巳" class="拓巳" src="ch01/00100080ta" mode="off">
...
<PRE box10>
[text703]
<voice name="拓巳" class="拓巳" src="ch01/00100090ta" mode="off">
...
<PRE box10>
[text004]
<voice name="拓巳" class="拓巳" src="ch01/00100100ta" mode="off">
//そこにあるのは、崩壊した街――
...
Delete("タクミ１");
SoundPlay("タクミ２",0,1000,false);}
<voice name="拓巳" class="拓巳" src="ch01/00100110ta" mode="off">
//そこにあるのは、絶望――
...
Delete("タクミ２");
SoundPlay("タクミ３",0,1000,false);}
<voice name="拓巳" class="拓巳" src="ch01/00100120ta" mode="off">
//そこにあるのは、死――
Therein lies death――
{$待ち時間 = RemainTime ("タクミ３");
$待ち時間 += 1500;
...
<voice name="拓巳" class="拓巳" src="ch01/00100130ta" mode="off">
//そこにあるのは、無――
...
<PRE box10>
[text005]
<voice name="拓巳" class="拓巳" src="ch01/00100140ta" mode="off">
//誰もいない。<?>
No one is here&. <?>
{$待ち時間 = RemainTime ("タクミ１");
$待ち時間 += 1000;
...
Delete("タクミ１");
SoundPlay("タクミ２",0,1000,false);}
<voice name="拓巳" class="拓巳" src="ch01/00100150ta" mode="off">
//誰も動いてない。<?>
No one is moving&. <?>
{$待ち時間 = RemainTime ("タクミ２");
$待ち時間 += 1000;
...
Delete("タクミ２");
SoundPlay("タクミ３",0,1000,false);}
<voice name="拓巳" class="拓巳" src="ch01/00100160ta" mode="off">
//誰も、生きていない。
No one is alive&.
{$待ち時間 = RemainTime ("タクミ３");
$待ち時間 += 2000;
...
Delete("タクミ３");
SoundPlay("タクミ４",0,1000,false);}
<voice name="拓巳" class="拓巳" src="ch01/00100170ta" mode="off">
//聞こえるのはただ、降り続ける雨の音だけ。
...
<PRE box10>
[text505]
<voice name="拓巳" class="拓巳" src="ch01/00100180ta" mode="off">
//このまますべてを――
...
Delete("タクミ１");
SoundPlay("タクミ２",0,1000,false);}
<voice name="拓巳" class="拓巳" src="ch01/00100190ta" mode="off">
//生きているものも、死んでいるものも、
both alive and dead――
{$待ち時間 = RemainTime ("タクミ２");
$待ち時間 += 1000;
...
Delete("タクミ２");
SoundPlay("タクミ３",0,1000,false);}
<voice name="拓巳" class="拓巳" src="ch01/00100200ta" mode="off">
...
<PRE box10>
[text901]
<voice name="拓巳" class="拓巳" src="ch01/00100210ta" mode="off">
...
<PRE box10>
[text506]
<voice name="拓巳" class="拓巳" src="ch01/00100220ta" mode="off">
//身体が、動かない。<?>
My body won't move&. <?>
{$待ち時間 = RemainTime ("タクミ１");
$待ち時間 += 1500;
...
Delete("タクミ１");
SoundPlay("タクミ２",0,1000,false);}
<voice name="拓巳" class="拓巳" src="ch01/00100230ta" mode="off">
//動かせるのはかろうじて、首と瞳だけ。
...
Delete("タクミ２");
SoundPlay("タクミ３",0,1000,false);}
<voice name="拓巳" class="拓巳" src="ch01/00100240ta" mode="off">
...
<PRE box10>
[text606]
<voice name="拓巳" class="拓巳" src="ch01/00100250ta" mode="off">
...
Delete("タクミ１");
SoundPlay("タクミ２",0,1000,false);}
<voice name="拓巳" class="拓巳" src="ch01/00100260ta" mode="off">
...
<PRE box10>
[text706]
<voice name="拓巳" class="拓巳" src="ch01/00100270ta" mode="off">
...
Delete("タクミ１");
SoundPlay("タクミ２",0,1000,false);}
<voice name="拓巳" class="拓巳" src="ch01/00100280ta" mode="off">
...
<PRE box10>
[text707]
<voice name="拓巳" class="拓巳" src="ch01/00100290ta" mode="off">
//それなのにいったい誰が、
...
<PRE box10>
[text806]
<voice name="拓巳" class="拓巳" src="ch01/00100300ta" mode="off">
//でも――
But――
{$待ち時間 = RemainTime ("タクミ１");
$待ち時間 += 2000;
...
<PRE box10>
[text906]
<voice name="拓巳" class="拓巳" src="ch01/00100310ta" mode="off">
//だったら僕はどこにいたんだろう？
...
Delete("タクミ１");
SoundPlay("タクミ２",0,1000,false);}
<voice name="拓巳" class="拓巳" src="ch01/00100320ta" mode="off">
//僕は、ここにいるのかな？
...
Delete("タクミ２");
SoundPlay("タクミ３",0,1000,false);}
<voice name="拓巳" class="拓巳" src="ch01/00100330ta" mode="off">
//僕は、どこにもいないのかな？
Am I nowhere?
{$待ち時間 = RemainTime ("タクミ３");
$待ち時間 += 2000;
...
<PRE box10>
[text007]
<voice name="拓巳" class="拓巳" src="ch01/00100340ta" mode="off">
...
<PRE box10>
[text507]
<voice name="拓巳" class="拓巳" src="ch01/00100350ta" mode="off">
...
<PRE box10>
[text902]
<voice name="拓巳" class="拓巳" src="ch01/00100360ta" mode="off">
//――君は、誰？
―― Who are you?
{$待ち時間 = RemainTime ("タクミ１");
$待ち時間 += 2000;
...
<PRE box10>
[text010]
<voice name="拓巳" class="拓巳" src="ch01/00100370ta" mode="off">
//その肌が青白く見えるのは――
...
<PRE box10>
[text410]
<voice name="拓巳" class="拓巳" src="ch01/00100380ta" mode="off">
//雨の冷たさに凍えているから？
//それとも、君がもう死んでいるから？
...
<PRE box10>
[text510]
<voice name="拓巳" class="拓巳" src="ch01/00100390ta" mode="off">
//でも、彼女は震えていなかった。
...
<PRE box10>
[text903]
<voice name="拓巳" class="拓巳" src="ch01/00100400ta" mode="off">
//――僕を、見るな。
―― Don't look at me&.
{$待ち時間 = RemainTime ("タクミ１");
$待ち時間 += 0;
...
<PRE box10>
[text011]
<voice name="拓巳" class="拓巳" src="ch01/00100410ta" mode="off">
//ひどく悲しそうにも見える。
//狂気じみているようにも見える。
//なにも映していないようにも見える。
...
<PRE box10>
[text511]
<voice name="拓巳" class="拓巳" src="ch01/00100420ta" mode="off">
//もしも――
If――
{$待ち時間 = RemainTime ("タクミ１");
$待ち時間 += 2000;
...
<PRE box10>
[text611]
<voice name="拓巳" class="拓巳" src="ch01/00100430ta" mode="off">
...
Delete("タクミ１");
SoundPlay("タクミ２",0,1000,false);}
<voice name="拓巳" class="拓巳" src="ch01/00100440ta" mode="off">
...
<PRE box10>
[text711]
<voice name="拓巳" class="拓巳" src="ch01/00100450ta" mode="off">
...
Delete("タクミ１");
SoundPlay("タクミ２",0,1000,false);}
<voice name="拓巳" class="拓巳" src="ch01/00100460ta" mode="off">
...
<PRE box10>
[text811]
<voice name="拓巳" class="拓巳" src="ch01/00100470ta" mode="off">
//彼女の瞳に映るものは、僕。
//僕の瞳に映るものは、彼女。
//そう考えると、世界は途端に矮小化する。
...
[text012]
//【梨深】
<voice name="梨深" class="梨深" src="ch01/00100010ri">
//「ねえ――」（※音声到着段階でテキスト削除）
"Hey――"
{WaitKey(500);}
</PRE>
...
<PRE box10>
[text013]
<voice name="拓巳" class="拓巳" src="ch01/00100480ta" mode="off">
...
<PRE box10>
[text014]
<voice name="拓巳" class="拓巳" src="ch01/00100490ta" mode="off">
//彼女はうなだれて――
She hangs her head――
{$待ち時間 = RemainTime ("タクミ１");
$待ち時間 += 2000;
...
Delete("タクミ１");
SoundPlay("タクミ２",0,1000,false);}
<voice name="拓巳" class="拓巳" src="ch01/00100500ta" mode="off">
//両手を、左右に広げる――
...
<PRE box10>
[text514]
<voice name="拓巳" class="拓巳" src="ch01/00100510ta" mode="off">
...
<PRE box10>
[text614]
<voice name="拓巳" class="拓巳" src="ch01/00100520ta" mode="off">
...
//以上、テキスト表示なし。音声のみで。
//【梨深】
<voice name="梨深" class="梨深" src="ch01/00100020ri">
「あなたを見つめる――」

//以下、テキスト表示なし。音声のみで。
//以上、テキスト表示なし。音声のみで。
//【梨深】
<voice name="梨深" class="梨深" src="ch01/00100030ri">
「妄想――」
...
//以上、テキスト表示なし。音声のみで。
//【梨深】
<voice name="梨深" class="梨深" src="ch01/00100040ri">
「殺してあげる――」
...
//以下、テキスト表示なし。音声のみで。
//【梨深】
<voice name="梨深" class="梨深" src="ch01/00100050ri">
「…………」
...
//以下、テキスト表示なし。音声のみで。
//【梨深】
<voice name="梨深" class="梨深" src="ch01/00100060ri">
「ん……っ」
